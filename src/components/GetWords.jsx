...
export default function GetWords(){
    ...
    const wordsFromField = () => {
        ...
        const submitFunction = (e) => {
            ...
            axios.post('http://localhost:3001/addCollection', dataForServer)
    ...
    const sendTxt = async () => {
        try {
            ...
            await axios.post('http://localhost:3001/uploadText', data, {
                headers: {
    ...
    const createCollection = () => {
        ...
        const addToAll = () => {
            ...
            axios.post('http://localhost:3001/addCollection', collection)
            .then(d => console.log(d))
            .catch(e => console.log(e))
        }
